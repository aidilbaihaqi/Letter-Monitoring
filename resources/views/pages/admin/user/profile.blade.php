                            ...
                            <form action="{{ route('user.update', $user->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="level" id="exampleRadios1" value="1" {{ $user -> level ? 'checked' : "" }}>
                                    ...
                                    @endif
                                      <div class="form-check">
                                        <input class="form-check-input" type="radio" name="level" id="exampleRadios2" value="0" {{ $user -> level ? '' : "checked" }}>
